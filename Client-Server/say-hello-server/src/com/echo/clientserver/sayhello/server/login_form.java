...
public class login_form extends javax.swing.JFrame {
    ...
    private void btn_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_loginMouseClicked
        try {
            sql = "SELECT * FROM Profil WHERE username='"+et_user.getText()+"' AND password='"+et_pass.getText()+"'";
            rs = stat.executeQuery(sql);
            if(rs.next()){
                if(et_user.getText().equals(rs.getString("username")) && et_pass.getText().equals(rs.getString("password"))){
