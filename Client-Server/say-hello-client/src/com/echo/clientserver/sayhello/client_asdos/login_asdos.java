 ...
 * @author R
 */
public class login_asdos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(et_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 146, 222, 36));
        ...
        jPanel2.add(et_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 209, 222, 36));
    ...
    private void btn_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_loginMouseClicked
        try {
            sayHello_client = (SayHello)Naming.lookup("rmi://localhost:1098/sayHello");
            ...
            JOptionPane.showMessageDialog(null, "Sever belum terhubung");
            et_user.setText("");
            et_pass.setText("");
        }
        
        try {
            sql_client = "SELECT * FROM profil_asdos WHERE username_asdos='"+et_user.getText()+"' AND password_asdos='"+et_pass.getText()+"'";
            rs_client = stat_client.executeQuery(sql_client);
            if(rs_client.next()){
                if(et_user.getText().equals(rs_client.getString("username_asdos")) && et_pass.getText().equals(rs_client.getString("password_asdos"))){
    ...
    public void pindahke2() {
        //Dashboard frm_dash = new Dashboard();
        //frm_dash.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_asdos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new login_asdos().setVisible(true);
            }
        });
    }
