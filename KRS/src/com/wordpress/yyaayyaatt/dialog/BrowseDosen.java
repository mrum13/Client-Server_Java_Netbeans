 ...
 * @author acer3250
 */
public class BrowseDosen extends javax.swing.JDialog {
    ...
    public BrowseDosen() {
        ...
        tblBuku.setModel(new SiswaTableModel(dosens));
    ...
    public void setSiswa(Dosen dosen) {
        this.dosen = dosen;
    }
    ...
    private class SiswaSelectionListener implements ListSelectionListener{
        ...
        public void valueChanged(ListSelectionEvent e) {
            if(tblBuku.getSelectedRow()>=0){
                dosen = dosens.get(tblBuku.getSelectedRow());
            }
        }
    ...
    private List<Dosen> list=new ArrayList<Dosen>();
        ...
        public SiswaTableModel(List<Dosen> dosens){
            this.list=dosens;
        }

   public Object getValueAt(int rowIndex, int columnIndex) {
            Dosen s = list.get(rowIndex);
            switch(columnIndex){
                case 0: return rowIndex+1;
                case 1: return s.getKd_dosen();
                case 2: return s.getDosen();
 ...
 if (evt.getKeyCode()==KeyEvent.VK_ENTER) {
     try {         
         {
            dosens = KRS.getDosenService().getCari(txtCari.getText());            
            if (dosens.equals(null)) return;
//                dosens=KRS.getDosenInterface().getDosen();
                tblBuku.setModel(new SiswaTableModel(dosens));
                render();
            }
