...
public class BrowseMahasiswa extends javax.swing.JDialog {
    ...
    private class SiswaSelectionListener implements ListSelectionListener{
        ...
        public void valueChanged(ListSelectionEvent e) {
            if(tblBuku.getSelectedRow()>=0){
                mahasiswa = mahasiswas.get(tblBuku.getSelectedRow());
            }
        }
    ...
    private List<Mahasiswa> list=new ArrayList<Mahasiswa>();
        ...
        public SiswaTableModel(List<Mahasiswa> mahasiswas){
            this.list=mahasiswas;
        }
   ...
   public Object getValueAt(int rowIndex, int columnIndex) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("NIM/Nama/Kelas :");
 ...
 if (evt.getKeyCode()==KeyEvent.VK_ENTER) {
     try {         
         {
            mahasiswas = KRS.getMahasiswaService().getCari(txtCari.getText());            
            if (mahasiswas.equals(null)) return;
//                mahasiswas=KRS.getMahasiswaInterface().getMahasiswa();
                tblBuku.setModel(new SiswaTableModel(mahasiswas));
                render();
            }
